...
class TestGNN(unittest.TestCase):
    ...
    def test_graph_wrapper(self):
        ...
        # Node features should be (100, 8)
        self.assertEqual(obs["node_features"].shape, (100, 8))
    ...
    def test_gnn_network_forward(self):
        net = GNNDQNetwork(node_feature_dim=8, action_size=5, gcn_hidden_dims=[16], mlp_hidden_dims=[16])
    ...
    def test_graph_replay_buffer(self):
        ...
        obs = {
            "node_features": np.zeros((10, 8), dtype=np.float32),
        ...
        # B = 2 -> total nodes = 20
        self.assertEqual(batch_obs.x.shape, (20, 8))
